  ...
  useEffect(() => {
    ...
    try {
        ...
        if (!institute || institute === 'all') {
          response = await axios.get('https://eduxcel-api-13march.onrender.com/api/institute/all');
        } else {
          response = await axios.get(`https://eduxcel-api-13march.onrender.com/api/institute/${institute}`);
        }
        if (!response) {
          response = await axios.get('https://eduxcel-api-13march.onrender.com/api/institute');
        }
